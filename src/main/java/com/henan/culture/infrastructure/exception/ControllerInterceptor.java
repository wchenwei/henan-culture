package com.henan.culture.infrastructure.exception;

import com.alibaba.fastjson.JSON;
import com.henan.culture.infrastructure.exception.model.ExceptionResponse;
...
public class ControllerInterceptor {
     ...
     */
    @Around(value = "execution (*  com.henan.culture.controller.login.*.*(..))")
